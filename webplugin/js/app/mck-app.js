    ...
    var mck_external_scripts = [
        {
            ...
            "url": "https://cdn-test.applozic.com/applozic/applozic.chat-5.9.min.js", // update the url with every new release of applozic-web-plugin
            "alternateUrl": MCK_STATICPATH + "/js/app/applozic.chat-5.9.min.js"
        }
    ];
